...
/*
    Esta clase busca establecer las pilas dinamicas como nodos, para después implementarlo en la clase de QueueOfStack,
    implementando sus "getters" y "setters"
 */
public class StackNode {

    private DynamicStack value; // declaro la pila como valor de nodo
    private StackNode next; // declaro un next para aclarar cuál va a ser su siguiente nodo
